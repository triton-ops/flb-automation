"""NJM-98766 — BCJ to Tape - Verify Backup Copy to Standalone Tape Drive.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-98766")]
...
def test_bcj_to_tape_verify_backup_copy_to_standalone():
    pass
