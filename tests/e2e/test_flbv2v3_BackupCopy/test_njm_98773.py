"""NJM-98773 — Recovery from Tape - Verify Recovery from a Robotic Tape Library/VTL.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-98773")]
...
def test_recovery_from_tape_verify_recovery_from_a_robotic():
    pass
