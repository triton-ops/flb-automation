"""NJM-123166 — Verify Copy to Immutable Synology C2 Repository.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-123166")]
...
def test_verify_copy_to_immutable_synology_c2_repository():
    pass
