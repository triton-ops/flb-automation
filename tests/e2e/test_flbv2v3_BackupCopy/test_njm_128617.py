"""NJM-128617 — Verify Active Full After Source File Deletion.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-128617")]
...
def test_verify_active_full_after_source_file_deletion():
    pass
