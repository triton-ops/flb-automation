"""NJM-128611 — Verify Active Full Creation (No Source Changes).
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-128611")]
...
def test_verify_active_full_creation_no_source_changes():
    pass
