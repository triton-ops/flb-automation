"""NJM-87457 — Recovery from Tape - Verify Recovery from a Full Recovery Point.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-87457")]
...
def test_recovery_from_tape_verify_recovery_from_a_full():
    pass
