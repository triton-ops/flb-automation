"""NJM-70168 — BCJ to Tape - Verify End-to-End Backup Copy to Tape Workflow.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-70168")]
...
def test_bcj_to_tape_verify_end_to_end_backup():
    pass
