"""NJM-87464 — Recovery from Tape - Wizard Step 1 - Verify Tape and Backup Selection.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-87464")]
...
def test_recovery_from_tape_wizard_step_1_verify_tape():
    pass
