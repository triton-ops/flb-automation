"""NJM-123165 — Verify Copy to Immutable Local Linux Repository.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-123165")]
...
def test_verify_copy_to_immutable_local_linux_repository():
    pass
