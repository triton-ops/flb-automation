"""NJM-70114 — BCJ for FLB - Destination Step - Verify Wasabi Repository is a Supported Target.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-70114")]
...
def test_bcj_for_flb_destination_step_verify_wasabi_repository():
    pass
