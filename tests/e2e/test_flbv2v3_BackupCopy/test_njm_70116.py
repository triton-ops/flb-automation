"""NJM-70116 — BCJ for FLB - Destination Step - Verify Amazon S3 Repository is a Supported Target.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-70116")]
...
def test_bcj_for_flb_destination_step_verify_amazon_s3():
    pass
