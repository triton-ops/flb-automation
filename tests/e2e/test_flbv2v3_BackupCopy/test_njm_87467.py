"""NJM-87467 — Recovery from Tape - Wizard Step 2 - Verify Destination Repository Selection.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-87467")]
...
def test_recovery_from_tape_wizard_step_2_verify_destination():
    pass
