"""NJM-128610 — Verify Synthetic Full Creation (No Source Changes).
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-128610")]
...
def test_verify_synthetic_full_creation_no_source_changes():
    pass
