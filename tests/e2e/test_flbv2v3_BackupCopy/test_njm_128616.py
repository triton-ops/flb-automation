"""NJM-128616 — Verify Synthetic Full After Source File Deletion.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-128616")]
...
def test_verify_synthetic_full_after_source_file_deletion():
    pass
