"""NJM-70112 — BCJ for FLB - Destination Step - Verify Amazon EC2 Repository is a Supported Target.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-70112")]
...
def test_bcj_for_flb_destination_step_verify_amazon_ec2():
    pass
