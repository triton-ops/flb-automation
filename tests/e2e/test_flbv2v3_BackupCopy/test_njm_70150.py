"""NJM-70150 — Verify Backup Copy to Amazon S3 Repository.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-70150")]
...
def test_verify_backup_copy_to_amazon_s3_repository():
    pass
