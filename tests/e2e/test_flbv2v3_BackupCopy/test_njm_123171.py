"""NJM-123171 — Verify Copy to Immutable Azure Blob Repository.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-123171")]
...
def test_verify_copy_to_immutable_azure_blob_repository():
    pass
