"""NJM-98772 — Recovery from Tape - Verify Recovery from a Standalone Tape Drive.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-98772")]
...
def test_recovery_from_tape_verify_recovery_from_a_standalone():
    pass
