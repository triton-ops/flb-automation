"""NJM-70136 — Verify Backup Copy of Backups from All Supported Windows OS.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-70136")]
...
def test_verify_backup_copy_of_backups_from_all_supported():
    pass
