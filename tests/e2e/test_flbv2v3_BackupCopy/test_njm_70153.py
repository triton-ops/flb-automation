"""NJM-70153 — Verify Backup Copy to Azure Blob Repository.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-70153")]
...
def test_verify_backup_copy_to_azure_blob_repository():
    pass
