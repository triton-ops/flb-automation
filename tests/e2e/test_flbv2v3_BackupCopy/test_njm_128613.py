"""NJM-128613 — Verify Active Full Creation (With Source Changes).
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-128613")]
...
def test_verify_active_full_creation_with_source_changes():
    pass
