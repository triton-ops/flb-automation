"""NJM-70115 — BCJ for FLB - Destination Step - Verify Backblaze B2 Repository is a Supported Target.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-70115")]
...
def test_bcj_for_flb_destination_step_verify_backblaze_b2():
    pass
