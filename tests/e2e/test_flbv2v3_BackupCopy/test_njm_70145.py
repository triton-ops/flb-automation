"""NJM-70145 — Verify Backup Copy to Amazon EC2 Repository.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-70145")]
...
def test_verify_backup_copy_to_amazon_ec2_repository():
    pass
