"""NJM-70148 — Verify Backup Copy to Wasabi Repository.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-70148")]
...
def test_verify_backup_copy_to_wasabi_repository():
    pass
