"""NJM-123170 — Verify Copy to Immutable Wasabi Repository.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-123170")]
...
def test_verify_copy_to_immutable_wasabi_repository():
    pass
