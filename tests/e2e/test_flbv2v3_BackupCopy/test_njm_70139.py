"""NJM-70139 — Verify Backup Copy to Onboard Repository.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-70139")]
...
def test_verify_backup_copy_to_onboard_repository():
    pass
