"""NJM-70117 — BCJ for FLB - Destination Step - Verify Azure Blob Repository is a Supported Target.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-70117")]
...
def test_bcj_for_flb_destination_step_verify_azure_blob():
    pass
