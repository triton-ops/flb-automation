"""NJM-98770 — BCJ to Tape - Verify Schedule and Retention Settings are Applied Correctly.
...
pytestmark = [pytest.mark.flb, pytest.mark.backupcopy, pytest.mark.jira("NJM-98770")]
...
def test_bcj_to_tape_verify_schedule_and_retention_settings():
    pass
