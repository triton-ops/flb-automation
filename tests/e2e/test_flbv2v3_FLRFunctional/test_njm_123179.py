"""NJM-123179 — FLR from FLB - Functional - Verify Recovery from an Immutable Azure Blob Backup Copy.

⚠ Not yet run: needs a real Backup Copy job on an immutable Azure Blob repository to
...
pytestmark = [pytest.mark.flb, pytest.mark.flrfunctional, pytest.mark.jira("NJM-123179")]

SKIP_REASON = (
    "Not yet run: needs a real Backup Copy job on an immutable Azure Blob "
...
def test_flr_from_flb_functional_verify_recovery_from_an_azure_backup_copy_immutable():
    pass
