"""NJM-123183 — FLR from FLB - Functional - Verify Recovery from an Immutable Backblaze B2 Backup Copy.

⚠ Not yet run: needs a real Backup Copy job on an immutable Backblaze B2 repository to
...
pytestmark = [pytest.mark.flb, pytest.mark.flrfunctional, pytest.mark.jira("NJM-123183")]

SKIP_REASON = (
    "Not yet run: needs a real Backup Copy job on an immutable Backblaze B2 "
...
def test_flr_from_flb_functional_verify_recovery_from_an_backblaze_backup_copy_immutable():
    pass
