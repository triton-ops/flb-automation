"""NJM-123189 — FLR from FLB - Functional - Verify Recovery from an Immutable NEC HYDRAstor Backup.
...
pytestmark = [pytest.mark.flb, pytest.mark.flrfunctional, pytest.mark.jira("NJM-123189")]
...
def test_flr_from_flb_functional_verify_recovery_from_an_hydrastor_immutable():
    pass
