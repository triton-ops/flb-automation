r"""NJM-123124 — [FLB v1] FLB - Functional - Verify Backup to Immutable Backblaze B2 Repository.
...
pytestmark = [pytest.mark.flb, pytest.mark.objectstorage, pytest.mark.jira("NJM-123124")]

REPOSITORY = "BlackBlaze_Immutable"


@allure.title("NJM-123124 — backup to immutable Backblaze B2 repository, 1-day immutability")
def test_backup_to_backblaze_immutable(logged_in_page, flb_job_cleanup):
    page = logged_in_page
    job_name = flb_job_cleanup("AUTO_FLB_NJM-123124_backblaze-immutable")
