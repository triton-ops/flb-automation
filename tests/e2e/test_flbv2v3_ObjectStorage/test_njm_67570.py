r"""NJM-67570 — [FLB v1] FLB Job Wizard - Destination Step - Verify Amazon S3 Repository is a
Supported Target.
...
pytestmark = [
    pytest.mark.flb, pytest.mark.objectstorage, pytest.mark.jira("NJM-67570"),
...
@allure.title("NJM-67570 — Amazon_Repo is a selectable Destination-step target")
def test_s3_is_supported_target(logged_in_page):
    page = logged_in_page
