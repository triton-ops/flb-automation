"""NJM-128575 — FLB - Platform - Verify End-to-End Workflow on QNAP (ARM x41) NAS.

⚠ BLOCKED: no QNAP (ARM x41) NAS device exists in this project's environment —
...
pytestmark = [pytest.mark.flb, pytest.mark.backupexecution, pytest.mark.jira("NJM-128575")]
...
def test_flb_platform_verify_end_to_end_workflow_on_qnap_arm_x41():
    pass
