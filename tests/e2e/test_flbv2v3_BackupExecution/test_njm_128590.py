"""NJM-128590 — FLB - Platform - Verify End-to-End Workflow on TrueNAS.

⚠ BLOCKED: no TrueNAS device exists in this project's environment —
...
pytestmark = [pytest.mark.flb, pytest.mark.backupexecution, pytest.mark.jira("NJM-128590")]
...
def test_flb_platform_verify_end_to_end_workflow_on_truenas():
    pass
