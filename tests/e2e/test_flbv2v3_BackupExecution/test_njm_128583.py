"""NJM-128583 — FLB - Platform - Verify End-to-End Workflow on Asustor (x86_64) NAS.

⚠ BLOCKED: no Asustor (x86_64) NAS device exists in this project's environment —
...
pytestmark = [pytest.mark.flb, pytest.mark.backupexecution, pytest.mark.jira("NJM-128583")]
...
def test_flb_platform_verify_end_to_end_workflow_on_asustor_x86_64():
    pass
