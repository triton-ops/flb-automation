"""NJM-128580 — FLB - Platform - Verify End-to-End Workflow on Synology DSM7 (ARMv8) NAS.

⚠ BLOCKED: no Synology DSM7 (ARMv8) NAS device exists in this project's environment —
...
pytestmark = [pytest.mark.flb, pytest.mark.backupexecution, pytest.mark.jira("NJM-128580")]

SKIP_REASON = (
    "BLOCKED: no Synology DSM7 (ARMv8) NAS device exists in this project's "
...
def test_flb_platform_verify_end_to_end_workflow_on_synology_dsm7_armv8():
    pass
