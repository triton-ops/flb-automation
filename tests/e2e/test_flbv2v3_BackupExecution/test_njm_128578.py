"""NJM-128578 — FLB - Platform - Verify End-to-End Workflow on Synology DSM6 (x86_64) NAS.

⚠ BLOCKED: no Synology DSM6 (x86_64) NAS device exists in this project's environment —
...
pytestmark = [pytest.mark.flb, pytest.mark.backupexecution, pytest.mark.jira("NJM-128578")]

SKIP_REASON = (
    "BLOCKED: no Synology DSM6 (x86_64) NAS device exists in this project's "
...
def test_flb_platform_verify_end_to_end_workflow_on_synology_dsm6_x86_64():
    pass
