"""NJM-128576 — FLB - Platform - Verify End-to-End Workflow on QNAP (ARMv8) NAS.

⚠ BLOCKED: no QNAP (ARMv8) NAS device exists in this project's environment —
...
pytestmark = [pytest.mark.flb, pytest.mark.backupexecution, pytest.mark.jira("NJM-128576")]
...
def test_flb_platform_verify_end_to_end_workflow_on_qnap_armv8():
    pass
