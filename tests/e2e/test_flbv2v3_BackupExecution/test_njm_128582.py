"""NJM-128582 — FLB - Platform - Verify End-to-End Workflow on Synology DSM7 (ARMv7) NAS.

⚠ BLOCKED: no Synology DSM7 (ARMv7) NAS device exists in this project's environment —
...
pytestmark = [pytest.mark.flb, pytest.mark.backupexecution, pytest.mark.jira("NJM-128582")]

SKIP_REASON = (
    "BLOCKED: no Synology DSM7 (ARMv7) NAS device exists in this project's "
...
def test_flb_platform_verify_end_to_end_workflow_on_synology_dsm7_armv7():
    pass
