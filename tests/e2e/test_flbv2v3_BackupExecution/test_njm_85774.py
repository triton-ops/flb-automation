"""NJM-85774 — FLB - Reliability - Verify Job State After Director Service is Stopped Mid-Job.

⚠ BLOCKED: needs a genuine mid-job service disruption (stopping the Director service)
...
pytestmark = [pytest.mark.flb, pytest.mark.backupexecution, pytest.mark.jira("NJM-85774")]

SKIP_REASON = (
    "BLOCKED: needs a genuine mid-job service disruption (stopping the Director "
    "service) triggered during an active job run — this project's UI-only "
...
def test_flb_reliability_verify_job_state_after_director_service():
    pass
