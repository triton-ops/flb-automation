"""NJM-128589 — FLB - Platform - Verify End-to-End Workflow on WD My Cloud PR4100.

⚠ BLOCKED: no WD My Cloud PR4100 device exists in this project's environment —
...
pytestmark = [pytest.mark.flb, pytest.mark.backupexecution, pytest.mark.jira("NJM-128589")]
...
def test_flb_platform_verify_end_to_end_workflow_on_wd_my_cloud_pr4100():
    pass
