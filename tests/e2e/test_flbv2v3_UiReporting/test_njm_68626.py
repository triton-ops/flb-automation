r"""NJM-68626 — [FLB v1] FLB - Multi-Tenancy - Verify Job for Windows Machine from a Sub-Tenant.
...
pytestmark = [pytest.mark.flb, pytest.mark.uireporting, pytest.mark.jira("NJM-68626")]
...
def test_job_windows_machine_from_sub_tenant():
    pass
