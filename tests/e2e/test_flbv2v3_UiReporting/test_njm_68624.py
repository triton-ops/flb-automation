r"""NJM-68624 — [FLB v1] FLB - Multi-Tenancy - Verify Job for Linux Machine from Master Tenant.
...
pytestmark = [pytest.mark.flb, pytest.mark.uireporting, pytest.mark.jira("NJM-68624")]
...
def test_job_linux_machine_from_master_tenant():
    pass
