"""NJM-177966 — Root folder renamed/moved/deleted at run time fails job with ict45.
...
pytestmark = [pytest.mark.flb, pytest.mark.reliability, pytest.mark.jira("NJM-177966")]
...
def test_root_folder_renamed_moved_deleted_at_run_time():
    pass
