"""NJM-177967 — Non-root items missing at run time are skipped and job continues.
...
pytestmark = [pytest.mark.flb, pytest.mark.reliability, pytest.mark.jira("NJM-177967")]
...
def test_non_root_items_missing_at_run_time_are():
    pass
