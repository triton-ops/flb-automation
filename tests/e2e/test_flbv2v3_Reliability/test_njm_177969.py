"""NJM-177969 — Transporter connection lost mid-job fails job with error13.
...
pytestmark = [pytest.mark.flb, pytest.mark.reliability, pytest.mark.jira("NJM-177969")]
...
def test_transporter_connection_lost_mid_job_fails_job_with():
    pass
