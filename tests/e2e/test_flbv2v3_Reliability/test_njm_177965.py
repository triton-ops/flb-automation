"""NJM-177965 — Volume snapshot creation failure falls back to direct volume read.
...
pytestmark = [pytest.mark.flb, pytest.mark.reliability, pytest.mark.jira("NJM-177965")]
...
def test_volume_snapshot_creation_failure_falls_back_to_direct():
    pass
