r"""NJM-63061 — [FLB v1] FLB Job Wizard - Source Step (UI): 'Select Items' dialog defaults to
volume view.

Pure UI-state check — no job is built. See test_njm_62788.py's module docstring for the shared
calibration note (identical body across this suite's 5 dialog-open/layout TCs).
"""
...
pytestmark = [
    pytest.mark.flb, pytest.mark.sourceselection, pytest.mark.jira("NJM-63061"),
...
@allure.title("NJM-63061 — 'Select Items' dialog opens with title, volume default, core elements")
