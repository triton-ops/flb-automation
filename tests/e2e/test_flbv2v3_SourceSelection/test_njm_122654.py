r"""NJM-122654 — [FLB v2] FLB Job Wizard - Source Step (UI): 'Select Items' dialog general layout.
...
NJM-122642 are duplicate "general layout" TCs — FLB v2 vs v1 revisions of the same coverage).
"""
...
pytestmark = [
    pytest.mark.flb, pytest.mark.sourceselection, pytest.mark.jira("NJM-122654"),
...
@allure.title("NJM-122654 — 'Select Items' dialog opens with title, volume default, core elements")
