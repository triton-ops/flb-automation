r"""NJM-122655 — [FLB v2] FLB Job Wizard - Source Step (UI): 'Select Items' dialog title.
...
pytestmark = [
    pytest.mark.flb, pytest.mark.sourceselection, pytest.mark.jira("NJM-122655"),
...
@allure.title("NJM-122655 — 'Select Items' dialog opens with title, volume default, core elements")
